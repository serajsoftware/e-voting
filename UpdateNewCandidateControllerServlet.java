...
public class UpdateNewCandidateControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        {  
            ...
            UpdateCandidateDTO updateDetails=new UpdateCandidateDTO(objValue.get(0),objValue.get(1),objValue.get(2),inp);        
            boolean result=CandidateDAO.updateCandidate(updateDetails);
            if(result)
