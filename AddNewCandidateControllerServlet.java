...
public class AddNewCandidateControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        {  
           ...
           CandidateDTO candidate=new CandidateDTO(objValue.get(0),objValue.get(3),objValue.get(4),objValue.get(1),inp);
           boolean checkCandidate=CandidateDAO.searchCandidate(objValue.get(3),objValue.get(4));
           ...
           {
               rd=request.getRequestDispatcher("verifycandidate.jsp");
           }
        }
        catch(Exception ex)
        {
