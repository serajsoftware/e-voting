    ...
    <body>
        <%
            ...
            displayBlock.append("<div class='container'>"+
                ...
                "<div class='card-body' id='dv1' onclick='redirectadministratorpage()'>"+
                 "<img src='images/administrator.png' alt='admin'><br>"+
                 "<a href=''>Admin Action </a></div></div></div>"+
                "<div class='col-4'>"+ 
                "<div class='card admin_card'>"+   
                "<div class='card-body' id='dv2' onclick='redirectvotingpage()'>"+   
                "<img src='images/voteadmin.jpg' alt='admin'><br>"+
                "<a href=''>Voting Page </a></div></div></div>"+
                "</div></div>");          
